                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="artists" id="artists" cols="30" class="form-control">{{ old('artists') }}</textarea>
                                  </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="writers" class="form-label">Writers</label>
                                    <textarea name="writers" id="writers" cols="30" class="form-control">{{ old('writers') }}</textarea>
                                  </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="sale_date" placeholder="AAAA-MM-GG" name="sale_date" required value="{{ old('sale_date') }}">
                                  </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="price" class="form-label">Price</label>
                                    <input type="number" min="0" max="1000" class="form-control" id="price" name="price" required value="{{ old('price') }}">
                                  </div>
                            </div>
                        </div>
